...
<body>
    <div class="container mt-3">
        ...
        <marquee style="background-color: red; color: white;"><b> FILL BELOW FORM TO CLOSE YOUR ACCOUNT...............THANK YOU</b></marquee>
        ...
        <div class="form-container">
            <h2 class="text-center">Close Your Account</h2>
            <form action="/closeacc" class="was-validated">
