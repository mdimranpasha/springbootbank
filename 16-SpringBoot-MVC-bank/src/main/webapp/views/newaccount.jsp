...
<head>
    ...
    <style>
        body {
            background-image: url('accountopen.jpg');
...
<body>
    <div class="container mt-3">
        ...
        <marquee style="background-color:white; color: red;"><b>Fill The Below Form To Complete Your Account Open Operation..........Thank You</b></marquee>
        ...
        <div class="form-container">
            <h2 class="text-center">Open Account Form</h2>
            <form action="/save" class="was-validated">
                <div class="form-group">
                    <label for="account_number">Account Number:</label>
                    <input type="text" class="form-control" id="account_number" placeholder="Enter Your Account Number" name="account_number" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="mobilenum" placeholder="Enter Mobile Number" name="mobilenum" required>
                </div>
